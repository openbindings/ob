...
Examples:
  ...
  curl -s https://api.example.com/openapi.json | ob inspect openbindings.openapi@6:-
  ob inspect --input '{"source":{"bindingSpec":"openbindings.openapi@6","location":"api.yaml"}}'`,
