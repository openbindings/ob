...
Examples:
  ...
  curl -s https://api.example.com/openapi.json | ob inspect openbindings.openapi@4:-
  ob inspect --input '{"source":{"bindingSpec":"openbindings.openapi@4","location":"api.yaml"}}'`,
