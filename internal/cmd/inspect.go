...
Examples:
  ...
  curl -s https://api.example.com/openapi.json | ob inspect openbindings.openapi@3:-
  ob inspect --input '{"source":{"bindingSpec":"openbindings.openapi@3","location":"api.yaml"}}'`,
