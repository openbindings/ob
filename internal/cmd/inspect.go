...
Examples:
  ...
  curl -s https://api.example.com/openapi.json | ob inspect openbindings.openapi@7:-
  ob inspect --input '{"source":{"bindingSpec":"openbindings.openapi@7","location":"api.yaml"}}'`,
