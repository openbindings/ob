...
Examples:
  ...
  curl -s https://api.example.com/openapi.json | ob inspect openbindings.openapi@5:-
  ob inspect --input '{"source":{"bindingSpec":"openbindings.openapi@5","location":"api.yaml"}}'`,
