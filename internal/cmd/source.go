...
Examples:
  ...
  ob source add my.obi.json openbindings.openapi@6:./api.yaml
  ob source add my.obi.json openapi.json --delegate ob
  ob source add my.obi.json 'openbindings.openapi@6:https://example.com/openapi.json?embed'
  ob source add my.obi.json openbindings.openapi@6:./api.yaml --uri https://cdn.example.com/api.yaml
  ob source add --input '{"interface":{"openbindings":"0.2.0","operations":{}},"source":{"bindingSpec":"openbindings.openapi@6","content":{"openapi":"3.1.0","info":{"title":"Example","version":"1"},"paths":{}}}}'`,
