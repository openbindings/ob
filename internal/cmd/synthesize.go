...
openbindings.openapi-3.1@1:-). A stdin artifact is content, not a location:
...
Examples:
  ...
  curl -s https://api.example.com/openapi.json | ob synthesize openbindings.openapi-3.1@1:- -o api.obi.json
  ob synthesize --input '{"sources":[{"bindingSpec":"openbindings.openapi-3.1@1","location":"api.yaml"}]}'`,
